...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for dist in livingGhostPositionDistributions:
            curr_pos = dist.argMax()
            curr_distance = self.distancer.getDistance(pacmanPosition, curr_pos)
        ...
        for a in legal:
            ...
            curr_distance_to_ghost = self.distancer.getDistance(next_pos, ghost_pos)
            if curr_distance_to_ghost < min_distance_to_ghost:
                min_distance_to_ghost = curr_distance_to_ghost
                action = a
        return action
